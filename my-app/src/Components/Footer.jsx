            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between flex-col py-14 gap-14 lg:gap-20 min-[1124px]:flex-row">
                    ...
                    <div class="flex flex-col items-center sm:items-start min-[530px]:flex-row max-[1124px]:w-full max-[1124px]:justify-between gap-12 xl:gap-24 max-[1124px]:max-w-2xl max-[1124px]:mx-auto">
                        <div class="block">
                            <h4 class="text-lg text-gray-900 font-medium mb-7 text-center lg:text-left">Home</h4>
                            <ul class="grid gap-6 text-center lg:text-left">
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Businesses</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Suppliers</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Use Cases</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">FAQ</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">About Us</a></li>
                            </ul>
                        </div>
                        <div class="block">
                            <h4 class="text-lg text-gray-900 font-medium mb-7 text-center lg:text-left">Support</h4>
                            <ul class="grid gap-6 text-center lg:text-left" >
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Account</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Supper Center</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Feedback</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Contact US</a></li>
                            </ul>
                        </div>
                        <div class="block">
                            <h4 class="text-lg text-gray-900 font-medium mb-7 text-center lg:text-left">Contact</h4>
                            <ul class="grid gap-6 text-center lg:text-left">
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Careers</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Terms of Service</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Privacy Policy</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Cookies Policy</a></li>
                                <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">@2024 Hussain. All rights reserved.</a></li>
                            </ul>
                        </div>
                    </div>
                    <div>
                    <div class="block  xl:max-w-lg">
                        <p class="text-xl text-gray-900 font-medium mb-7 text-center lg:text-left">Tranch you later, innovator. </p>
                        <div class="relative lg:flex-row gap-3 flex-col lg:flex lg:items-center justify-between max-[1124px]:max-w-2xl max-[1124px]:mx-auto">
                         
                            <input type="text" name="email" class="py-3 px-5 h-14 pl-14 border border-gray-300  text-lg text-gray-900 placeholder:text-gray-400 focus:outline-none flex-1 w-full" placeholder="Subscribe now" />
                            <button type="submit" class="h-14 py-3.5 px-7 bg-black transition-all duration-500 shadow-md rounded-full text-white font-semibold hover:bg-indigo-700 lg:ml-0 mt-2 lg:mt-0">Submit</button>
                        </div>

                    </div>
                    <div class="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 p-3 ">
                        <a href="javascript:;" class="w-9 h-9 rounded-full bg-black  flex justify-center items-center hover:bg-indigo-600">
